...
class WeatherStation
{
    ...
    {
        double m = random.NextDouble() * meanTemperature; // @TODO: maybe we need Gaussian here
...
class CreateMeasurements
{
    ...
    public static void CreateFile(string fileName, long size)
    {
        ...
        // @formatter:on
        List<WeatherStation> stations = new() {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            WeatherStation station = stations[random.Next(stations.Count())];
            writer.Write(station.id);
            writer.Write(";" + station.measurement());
            writer.Write('\n');
        }
